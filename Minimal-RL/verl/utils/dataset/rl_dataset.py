...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        self.cache_dir = os.path.expanduser("/scratch/gpfs/xq5452/cache/verl/rlhf")
    ...
    def _read_files_and_tokenize(self):
        ...
        for parquet_file in self.data_files:
            ...
            dataframe = datasets.load_dataset("parquet", data_files=parquet_file, cache_dir="/scratch/gpfs/xq5452/cache/datasets")["train"]
